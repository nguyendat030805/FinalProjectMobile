...
import ProductDetailScreen from './user/ProductDetailScreen';
import CategoriesScreen from './CategoriesScreen';
import CartScreen from './user/CartScreen';
import CheckoutScreen from './user/CheckoutScreen';
import OrderConfirmScreen from './user/OrderConfirmScreen';
import OrderHistoryScreen from './user/OrderHistoryScreen';
